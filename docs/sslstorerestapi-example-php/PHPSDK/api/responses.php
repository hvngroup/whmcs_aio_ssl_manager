...
class digicert_list_organization_response extends baseresponse{
    public $OrganizationList;
}

class digicert_organization_info_response extends baseresponse{
    public $Name;
    public $AssumedName;
    public $Address;
    public $Address2;
...
class digicert_get_domain_info_response extends baseresponse{
    public $DomainName;
