...
messagehelper::writeinfo('Order Mid-Term Upgrade');
...
$neworder->DNSNames = array ('2.domain.com');
...
$neworder->RelatedTheSSLStoreOrderID = ''; //Old TheSSLStoreOrderID
$neworder->FileAuthDVIndicator = true; //USED For DV File Authentication. You need to pass value "true".
...
$neworder->TSSOrganizationId = 0; // Used for Digicert products, If Organization prevously registered then just pass TheSSLStore’s organization id. // for live: 2101465
...
messagehelper::writevarinfo($neworderresponse = $sslapi->order_midterm_upgrade($neworder));
