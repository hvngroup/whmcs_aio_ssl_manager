...
class order_inviteorder_request extends baserequest
{
    ...
    public $IsWildcardCSRDomain;
    public $ExtraWildcardSAN;
}
...
class order_neworder_request extends baserequest
{
    ...
    public $TSSOrganizationId;
    public $WildcardReserveSANCount;
}
...
class digicert_list_organization_request extends baserequest{
    //
}

class digicert_organization_info_request extends baserequest{
    public $TSSOrganizationId;
}

class digicert_get_domain_info_request extends baserequest{
    public $TheSSLStoreOrderID;
    public $DomainName;
}
