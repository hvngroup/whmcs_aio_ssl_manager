...
class sslstore
{
    ...
    */
    ...
    public function digicert_list_organization($digicert_list_organization_request)
    {
        ...
        $resp = new digicert_list_organization_response();
        $apidetails = $this->getAPIRequest();
    ...
    public function digicert_organization_info($digicert_organization_info_request)
    {
        ...
        $resp = new digicert_organization_info_response();
        return $this->postToCurl($url,$digicert_organization_info_request,$resp);
    }

    /**
     * @param digicert_get_domain_info_request $digicert_get_domain_info_request
     * @return digicert_get_domain_info_response
     */
    public function digicert_get_domain_info($digicert_get_domain_info_request)
    {
        $url = $this->getURL() . '/digicert/getdomaininfo/';
        $resp = new digicert_get_domain_info_response();
        return $this->postToCurl($url,$digicert_get_domain_info_request,$resp);
    }
